namespace ROOT.CIMV2.Win32 {
    ...
    // De functies ShouldSerialize<PropertyName> zijn functies die worden gebruikt in de VS-eigenschapsbrowser om te controleren of een bepaalde eigenschap moet worden geserialiseerd. Deze functies worden toegevoegd voor alle ValueType-eigenschappen (eigenschappen van het type Int32, BOOL etc. die niet kunnen worden ingesteld op null). Deze functies maken gebruik van de functie Is<PropertyName>Null. Zij worden tevens gebruikt in de TypeConverter-implementatie voor de eigenschappen om te controleren op NULL-waarden, zodat een lege waarde kan worden getoond in de eigenschapsbrowser wanneer slepen-en-neerzetten wordt gebruikt in Visual Studio.
    // De functies in de vorm van Is<PropertyName>Null() worden gebruikt om te controleren of een eigenschap NULL is.
    // De functies Reset<PropertyName> worden toegevoegd voor Nullable Read/Write-eigenschappen. Deze functies worden gebruikt in de eigenschapsbrowser van VS Designer om een eigenschap in te stellen op NULL.
    // Elke eigenschap die wordt toegevoegd aan de klasse voor de WMI-eigenschap kent kenmerken waarmee het gedrag in Visual Studio Designer wordt gedefinieerd en waarmee een te gebruiken TypeConverter wordt gedefinieerd.
    ...
    // Een Early Bound-klasse die wordt gegenereerd voor de WMI-klasse.Win32_NetworkAdapter
    public class NetworkAdapter : System.ComponentModel.Component {
        
        // Persoonlijke eigenschap die de WMI-naamruimte bevat waarvan de klasse deel uitmaakt.
        private static string CreatedWmiNamespace = "root\\CimV2";
        
        // Persoonlijke eigenschap waarin de naam wordt opgeslagen van de WMI-klasse waarmee deze klasse is gemaakt.
        private static string CreatedClassName = "Win32_NetworkAdapter";
        
        // Persoonlijke-lidvariable waarin de ManagementScope wordt opgeslagen die door de verschillende methoden wordt gebruikt.
        ...
        // Lidvariabele waarin het automatic commit-gedrag van de klasse kan worden opgeslagen.
        private bool AutoCommitProp;
        
        // Persoonlijke variabele waarin de ingesloten eigenschap wordt opgeslagen die het exemplaar vertegenwoordigt.
        private System.Management.ManagementBaseObject embeddedObj;
        
        // Het huidige WMI-object dat wordt gebruikt
        private System.Management.ManagementBaseObject curObj;
        
        // Vlag waarmee wordt aangegeven of het exemplaar een ingesloten object is.
        private bool isEmbedded;
        
        // Hieronder vindt u verschillende constructors die via overloading zijn uitgebreid, waarmee u een exemplaar van de klasse met een WMI-object kunt initialiseren.
        ...
        public NetworkAdapter(System.Management.ManagementObject theObject) {
            ...
            if ((CheckIfProperClass(theObject) == true)) {
                ...
                throw new System.ArgumentException("De klassenaam komt niet overeen.");
            }
        }
        ...
        // Eigenschap retourneert de naamruimte van de WMI-klasse.
        [Browsable(true)]
        ...
        // Eigenschap die verwijst naar een ingesloten object om de System-eigenschappen van het WMI-object op te halen.
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        // Eigenschap die het onderliggende lateBound-object retourneert.
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        // Openbare eigenschap met statisch bereik die wordt gebruikt door de verschillende methoden.
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
...
.. - Other - For integer values other than those listed above, refer to Win32 error code documentation.")]
        ...
        // Hiermee wordt een bepaalde datetime met DMTF-indeling geconverteerd naar een System.DateTime-object.
        ...
        // Hiermee wordt een bepaald System.DateTime-object geconverteerd naar DMTF datetime-indeling.
        ...
        // Verschillende uitbreidingen via overload van GetInstances() maken het inventariseren van exemplaren van de WMI-klasse gemakkelijker.
        ...
        // Enumerator-implementatie voor het inventariseren van exemplaren van de klasse.
